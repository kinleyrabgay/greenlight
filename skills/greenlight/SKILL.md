---
name: greenlight
description: Validate your code changes through the greenlight pipeline - automated code review, tests, lint, docs, push, PR, and CI - before they reach upstream. Use when the user asks to run greenlight, gate or ship or validate their changes, push safely, asks you to do a task and then validate it, or invokes /greenlight.
user-invocable: true
---
