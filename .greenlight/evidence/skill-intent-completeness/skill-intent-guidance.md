...
This artifact captures the reviewer-visible guidance now present in the generated `greenlight` skill.

Source of truth checked: `internal/skill/skill.go`.
Generated skill checked: `skills/greenlight/SKILL.md`.
Dogfooded install copy checked: `.agents/skills/greenlight/SKILL.md`.
...
The generator check reported `skills/greenlight/SKILL.md` is up to date, demonstrating that the committed generated skill matches `internal/skill/skill.go`.
