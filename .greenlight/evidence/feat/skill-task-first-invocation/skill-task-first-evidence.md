# Task-First `/greenlight` Skill Evidence

This evidence captures the end-user skill prompt surface generated from `internal/skill/skill.go` into `skills/greenlight/SKILL.md`.
...
```text
genskill: skills/greenlight/SKILL.md is up to date
```

## Generated Skill Excerpt

Source: `skills/greenlight/SKILL.md`
