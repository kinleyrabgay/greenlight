...
hero:
  ...
  actions:
    - text: Get Started
      link: /greenlight/start-here/quick-start/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/kinleyrabgay/greenlight
      icon: external
---
...
branch is already public. `greenlight` moves more of that loop closer to where
you are working.
...
flowchart LR
  ...
  subgraph after[" With greenlight "]
    direction TB
    E["Local branch"] -->|"git push greenlight"| F["Local gate"]
...
- [Quick Start](/greenlight/start-here/quick-start/) - first gated push in a few minutes
- [Introduction](/greenlight/start-here/introduction/) - why the tool exists and how to think about it
- [The Gate Model](/greenlight/concepts/gate-model/) - architecture, push flow, and design choices
