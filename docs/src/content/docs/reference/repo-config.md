...
description: All fields for .greenlight.yaml.
---

Per-repo configuration lives in `.greenlight.yaml` at the root of your repository.
...
| `test.evidence.dir` | `string` | Inherits from global (default `.greenlight/evidence`) |
