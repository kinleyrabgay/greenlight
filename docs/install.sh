...
INSTALL_DIR="${GREENLIGHT_INSTALL_DIR:-$HOME/.greenlight/bin}"
LINK_DIR="${GREENLIGHT_LINK_DIR:-}"
...
BIN_PATH="$INSTALL_DIR/greenlight"
LINK_PATH="$LINK_DIR/greenlight"
...
FILENAME="greenlight-${VERSION}-${OS}-${ARCH}.tar.gz"
URL="https://github.com/${REPO}/releases/download/${VERSION}/${FILENAME}"

TMPDIR="$(mktemp -d)"
trap 'rm -rf "$TMPDIR"' EXIT

echo "Downloading greenlight ${VERSION} for ${OS}/${ARCH}..."
...
echo "greenlight ${VERSION} installed to ${BIN_PATH}"
