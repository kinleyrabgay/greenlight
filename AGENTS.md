...
This repository is a Go CLI app named `greenlight`.
The binary entrypoint is `cmd/greenlight`.
...
- Plain build: `go build -o ./bin/greenlight ./cmd/greenlight`
...
- `cmd/greenlight`: process entrypoint
