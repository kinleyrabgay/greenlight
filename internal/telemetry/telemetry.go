...
const (
	defaultHostname = "cli"
	defaultTitle    = "greenlight CLI"
	defaultPath     = "/api/send"
	defaultHost     = "https://a.kinleyrabgay.com"

	umamiHostEnv      = "GREENLIGHT_UMAMI_HOST"
	umamiWebsiteIDEnv = "GREENLIGHT_UMAMI_WEBSITE_ID"
	telemetryEnv      = "GREENLIGHT_TELEMETRY"
)
...
func (c *Client) send(ctx context.Context, payload []byte) {
	...
	req.Header.Set("User-Agent", fmt.Sprintf("greenlight/%s telemetry", c.version))
