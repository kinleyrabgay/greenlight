...
// TestAxiAgentJourney proves an autonomous agent can drive a full greenlight
// pipeline headlessly through the `greenlight axi` surface in an isolated
...
// assertSkillInstalled verifies init wrote the greenlight skill into both
...
func assertSkillInstalled(t *testing.T, h *Harness) {
	...
	for _, rel := range []string{
		filepath.Join(".claude", "skills", "greenlight", "SKILL.md"),
		filepath.Join(".agents", "skills", "greenlight", "SKILL.md"),
	} {
