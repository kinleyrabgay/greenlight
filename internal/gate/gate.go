...
// Init sets up a greenlight gate for the git repo at workDir.
...
// Git supports config --worktree, adds the greenlight remote, and records
...
// the gate identified by the leftover greenlight remote is reattached at the
...
// after init: it carries a greenlight remote pointing at a gate in our repos
...
// Eject removes the greenlight gate from the repo at workDir.
