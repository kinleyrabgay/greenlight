...
const (
	...
	systemdServiceNameBase  = "greenlight-daemon"
	windowsTaskNameBase     = "greenlight-daemon"
)
...
const (
	legacyLaunchdServiceLabel = "com.kinleyrabgay.greenlight.daemon"
	legacySystemdServiceName  = "greenlight-daemon.service"
	legacyWindowsTaskName     = "greenlight-daemon"
)
...
//
// Without scoping, the launchd label com.kinleyrabgay.greenlight.daemon (and
// its systemd/Windows equivalents) is a shared slot. Any greenlight process
// on the machine can `launchctl bootout gui/<uid>/com.kinleyrabgay.greenlight.daemon`
