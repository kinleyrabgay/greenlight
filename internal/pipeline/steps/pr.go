...
import (
	...
	"github.com/kinleyrabgay/greenlight/internal/conventional"
...
Diff stat:
%s%s%s%s`, branch, baseSHA, sctx.Run.HeadSHA, effectiveBaseBranch(sctx), conventional.ReleaseTypeRule, commitLog, diffStat, pipelineContext, userIntentPromptSection(sctx), executionContextPromptSection())
