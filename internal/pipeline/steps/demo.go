...
func DemoSteps() []pipeline.Step {
	return []pipeline.Step{
		...
		&demoStep{
			...
			log:        "Running: go test -race ./...\n\nok  \tgithub.com/kinleyrabgay/greenlight/internal/handler\t1.2s\nok  \tgithub.com/kinleyrabgay/greenlight/internal/config\t0.8s\nok  \tgithub.com/kinleyrabgay/greenlight/internal/server\t1.5s\n\nPASS",
		},
		&demoStep{
		...
		&demoStep{
			...
			log:        "Pushing to origin...\nTo github.com:kinleyrabgay/greenlight.git\n   a1b2c3d..e4f5g6h  fix/nil-check -> fix/nil-check",
		},
		&demoStep{
			name:       types.StepPR,
			delay:      3 * time.Second,
			displayDur: 8 * time.Second,
			log:        "Creating pull request...\nhttps://github.com/kinleyrabgay/greenlight/pull/42",
			prURL:      "https://github.com/kinleyrabgay/greenlight/pull/42",
		},
		&demoCIStep{
