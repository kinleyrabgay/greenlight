// Command genskill renders the canonical greenlight SKILL.md from the
// internal/skill package into skills/greenlight/SKILL.md. The same rendering
// is what `greenlight init` installs into the user-level agent skill
